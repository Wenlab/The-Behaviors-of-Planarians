...
output_folder = 'F:\1_learning\research\planarian\result\20230728\video';  % specify your desired output directory here
video = VideoWriter(fullfile(output_folder, [save_file_name '.avi']));
video.FrameRate = 2;
